                ...
                <div className="component-wrapper__text-display">
                    ...
                    <div className="component-wrapper__text-display__text-wrapper">
                        ...
                        (gif.includes("Egg-Hatched")) ? (
                            (displayMessageNo === 0) ? (
                                <>
                                    <div>Hello!. I am your digital friend. I grow as your career grows 🐣 I am here to keep you company. 
                                        You can play with me by clicking and dragging.
                                    </div>
                                    <div>
                                        <span className="component-wrapper__text-display__text-wrapper__name-me" onClick={() => {setDisplayMessageNo(1)}}>Click here to name</span>
                                    </div>
                                ...
                                <>
                                    ...
                                    <div>
                                        <input type="text" className="component-wrapper__text-display__text-wrapper--input" onChange={handlePlayerName} />
                                    </div>
                                    <div>Dress me</div>
                                    <div className="tomagachi-player-selector-wrapper">
                                        {Object.values(players).map((value, i) => (
                                            <div key={i} onClick={() => { handlePlayerSelector(Object.keys(players)[i], tempName) }}>
                                                <img className="tomagachi-player-img" src={value} alt="pic" />
                                            </div>
                                        ))}
                                    </div>
                                </>
                            )
                        ) : (<span>Hi there<br /><br />Click on Me</span>)}
                    </div>
                </div>
                :""
            }
